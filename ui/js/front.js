...
/*!
  * Variables y Metodos 23 Noviembre
  * JCM
------------------------------*/
var MetodoEnum = {
  Validar_Fecha:1,
...
function loadingCoupon(d){
  if(d==="VUELVE")
  {
    ...
    window.location.href = "index-agotado.html";
  }
  else if(d==="AGOTADO") {
    ...
    } else if (!cB && window.innerWidth < 960) {
      arch='ui/img/temp/promoMob-'+d+'.jpg';
    } else if (!cB && window.innerWidth >= 960) {
      arch='ui/img/temp/promoMob-'+d+'.jpg';
    }
...
function generateCoupon(i){
  interno = i;
  if(cB){
    cuponimg.style.backgroundImage = "url('ui/img/temp/promoMob-"+interno+".jpg')";
  } else if (!cB && window.innerWidth < 960) {
    cuponimg.style.backgroundImage = "url('ui/img/temp/promoMob-"+interno+".jpg')";
  } else if (!cB && window.innerWidth >= 960) {
    cuponimg.style.backgroundImage = "url('ui/img/temp/promoMob-"+interno+".jpg')";
